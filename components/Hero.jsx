...
export default function Hero() {
  return (
    <div className="flex flex-col md:flex-row  items-center w-full justify-center h-[100vh] md:h-[calc(110vh-126px)] 2xl:h-[80vh]">
      ...
      <div className="static md:relative w-full md:w-4/12 lg:w-5/12 text-right z-1 md:h-screen order-1 md:order-2">
        <img
          ...
          alt=""
        />
        <div className="w-1/2 mx-auto -z-10 opacity-30 md:opacity-100 mt-5 absolute md:w-full md:top-20 lg:top-0 right-0 ">
          <Image src={heroImage} />
        </div>
        <img
          src="/blue-square.svg"
